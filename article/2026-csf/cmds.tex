...
\newcommand{\AS}[1]{\todo[color=purple!30]{TODO: #1}}
\newcommand{\ASin}[1]{\todo[color=purple!30,inline]{TODO: #1}}

\newcommand{\FL}[1]{\todo[color=yellow!30]{TODO: #1}}
\newcommand{\FLin}[1]{\todo[color=yellow!30,inline]{TODO: #1}}

\newcommand{\RF}[1]{\todo[color=green!30]{TODO: #1}}
\newcommand{\RFin}[1]{\todo[color=green!30,inline]{TODO: #1}}

\newcommand{\LG}[1]{\todo[color=red!30]{TODO: #1}}
\newcommand{\LGin}[1]{\todo[color=red!30,inline]{TODO: #1}}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% My shortcuts
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\pkcs}[0]{\ms{PKCS11}\xspace}
