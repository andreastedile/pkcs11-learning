...
def dks3_attack_aes_ecb(session: Session):
    """
    ...
    k2_k2 = session.wrapKey(n2, n2, Mechanism(CKM_AES_ECB))
    ...
    n4 = session.unwrapKey(n2, k2_k2, template, Mechanism(CKM_AES_ECB))
    ...
    recovered = session.decrypt(n4, k1_k2, Mechanism(CKM_AES_ECB))
